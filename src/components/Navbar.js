...
const Navbar = () => {
  ...
  return (
    <header className="text-white body-font fixed inset-x-0 z-50 bg-[#22311d]">
      <div className="mx-auto py-2 px-5 flex flex-row justify-between items-center lg:py-4">
        ...
        >
          <img
            className="w-28 h-16 ml-3 cursor-pointer scale-125 lg:scale-150 lg:ml-10"
          ...
          {links.map((item) => {
            return (
              <Link
                ...
                duration={750}
                to={item.link}
                className="mr-5 cursor-pointer hover:text-[#8A9A5B] md:mr-12"
              >
                {item.title}
              </Link>
            );
        ...
        {isMenuOpen && (
          <div className="min-h-[calc(100vh-4rem)] absolute inset-x-0 top-16 z-50 transition-all ease-in duration-1000 lg:hidden">
            <div className="rounded-b-lg bg-[#22311d] shadow-lg px-5 pb-4">
              <nav
                ...
                {links.map((item) => {
                  return (
                    <Link
                      ...
                      duration={750}
                      to={item.link}
                      className="cursor-pointer hover:text-[#8A9A5B]"
                    >
                      {item.title}
                    </Link>
                  );
