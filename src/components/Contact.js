        ...
        <div className="flex flex-col gap-2 md:flex-row w-full mx-auto rounded-xl bg-[#22311d] p-4 md:gap-7 lg:gap-9 lg:rounded-2xl xl:gap-10">
          <div className="p-2 w-full text-center lg:p-5 xl:p-7 md:w-1/2 lg:w-4/6">
            <h1
              ...
              data-aos-duration="1000"
              data-aos-once="false"
              className="hidden md:block text-2xl lg:text-3xl text-[#8A9A5B] mb-3 lg:mb-4"
            >
              Get In Touch
            </h1>
            <div
            ...
            >
              ...
              <p className="text-white md:text-lg ">+91 6307437487</p>
            </div>
            <div
              data-aos="fade-right"
              data-aos-duration="1000"
            ...
            >
              ...
              >
                apoorvsrivastava2121@gmail.com
              </a>
            </div>
            <div
              data-aos="fade-right"
          ...
          >
            ...
            >
              <textarea
                ...
                placeholder="Message"
                name="message"
                className="overflow-y-scroll  mb-1 w-full bg-white rounded-md border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-black p-2 resize-none leading-6 transition-colors duration-200 ease-in-out"
              ></textarea>
            </div>
            <div
              data-aos="zoom-in"
              ...
              className="p-2 w-full"
            >
              <button className="inline-flex font-medium text-white bg-[#8A9A5B] border-2 border-white py-3 px-7 focus:outline-none hover:bg-cornsilk hover:border-black hover:text-black rounded-full text-md xl:px-10">
                Send
              </button>
            </div>
          </form>
