      ...
      <div className="p-5 mx-auto gap-2 flex flex-col md:pt-12 md:px-7 lg:py-20 lg:flex-row-reverse items-center min-h-fit">
        ...
        >
          <img
            ...
            alt="Apoorv"
            src={require("../assets/Images/myProfile.png")}
          />
        </div>
        <div className="lg:flex-grow lg:pr-4 lg:mr-14 flex flex-col md:mb-0 items-center text-center xl:scale-105">
          ...
          >
            Passionate MERN stack developer who loves crafting sleek,
          ...
          >
            Turning ideas into digital experiences is what I do best!
          </p>
          <div
            data-aos="zoom-in-up"
            data-aos-duration="2000"
          ...
          >
            <button className="inline-flex font-medium text-white bg-black border-2 border-white py-3 px-7 focus:outline-none hover:border-dark-orange  hover:bg-cornsilk hover:text-black rounded-full text-md xl:px-10">
              <Link
                to={"contact"}
                spy={true}
                smooth={true}
            ...
            <a
              href="https://drive.google.com/file/d/17B8aMbV71N050pAQGgqHBtLd7g4vp4tf/view?usp=drive_link"
              target="_blank"
              rel="noreferrer"
            >
              <button className="inline-flex font-medium text-white bg-[#8A9A5B] border-2 border-white py-3 px-7 focus:outline-none hover:border-dark-orange  hover:bg-cornsilk hover:text-black rounded-full text-md xl:px-10">
                Get Resume
              </button>
            </a>
          </div>
